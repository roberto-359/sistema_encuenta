...
if (isset($_SESSION['u_usuario'])) {
    echo '<span style="color: #FFFFFF;">Bienvenido ' . $_SESSION['u_usuario'] . '</span>';
    echo '<a href="../cerrar_sesion.php" class="btn btn-danger" style="margin-left: 10px; color: #FFFFFF;">Cerrar Sesión</a>';
} else {
